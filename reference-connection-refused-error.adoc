...
[role="lead"]
Un  `Connection refused`message indique que le serveur CIM utilisé par NetApp SMI-S Provider n'a pas été démarré. Vérifiez l'état du serveur CIM et démarrez-le si nécessaire.
