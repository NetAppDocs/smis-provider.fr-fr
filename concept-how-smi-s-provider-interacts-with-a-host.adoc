...
image::../media/smi_s_agent_and_host_interaction.gif[Un diagramme illustrant un hôte envoyant des requêtes au fournisseur SMI-S Provider CIMOM, au référentiel, aux DLL du fournisseur et au système de stockage]
