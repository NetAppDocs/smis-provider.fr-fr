...
[role="lead"]
NetApp SMI-S Provider 5.2.7 introduit de nouvelles exigences et limitations, notamment concernant les versions de Windows et de System Center Virtual Machine Manager (SCVMM) prises en charge. Examinez ces modifications avant de déployer ou de mettre à niveau vers cette version.
