...
[role="lead"]
NetApp SMI-S Provider risque de ne pas répondre à une requête si aucun système de stockage n'a été ajouté au référentiel CIMOM. Vérifiez si un système de stockage est enregistré et ajoutez-en un si nécessaire.
