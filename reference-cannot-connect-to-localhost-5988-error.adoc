...
[role="lead"]
NetApp SMI-S Provider peut ne pas se connecter à `localhost:5988` lorsque les paramètres de connexion requis sont désactivés ou mal configurés, ou lorsque le fournisseur a cessé de répondre. Vérifiez vos paramètres de connexion et redémarrez le fournisseur pour résoudre le problème.
