...
[role="lead"]
NetApp SMI-S Provider peut parfois se bloquer dans un environnement Windows. Collectez les fichiers de vidage, de journal et de trace générés au moment du blocage et envoyez-les au support technique pour une analyse approfondie.
