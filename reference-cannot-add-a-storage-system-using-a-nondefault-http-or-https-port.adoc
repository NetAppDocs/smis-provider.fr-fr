...
[role="lead"]
Vous ne pouvez pas ajouter un système de stockage NetApp au NetApp SMI-S Provider lorsque ce système utilise HTTP ou HTTPS sur un port non par défaut. Ajoutez le système de stockage en spécifiant explicitement le port non par défaut.
